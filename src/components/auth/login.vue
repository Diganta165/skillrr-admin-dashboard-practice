    ...
    <div class="skiller_sign_in_area d_flex align_center justify_center">
        <div class="skiller_sign_in_wrapper">
            ...
            <div class="skiller_form_wrapper">
                ...
                <form action="" class="skiller_form" @submit.prevent="login">
                   <label class="skiller_type_mail mb20">
                       <input type="text" placeholder="Email" v-model="userData.email"  @blur="isItValidEmail()" @focus="removeEmailValidationError()">
                            <span v-if="errors.length>0" style="color:red" class="error">{{errors}}</span>
                   </label>
                   ...
                   <label class="skiller_type_pass mb10">
                       <input :type="form.type" placeholder="Password" v-model="userData.password">
                       <svg  @click="changePasswordType" xmlns="http://www.w3.org/2000/svg" width="16" height="12.457" viewBox="0 0 16 12.457">
                  ...
                  <p id="forgot_pass"> <a href="#" class="mb20">Forgot Password?</a></p>
                    <button class="sign_in_btn mb30" :disabled = "form.isSubmitting">
                       Sign In
                    </button> 
                    <p style="color:green" class="blink" v-if="form.blinkStatus">successfully logged in</p>
                </form>
